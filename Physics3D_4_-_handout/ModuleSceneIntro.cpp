...
bool ModuleSceneIntro::Start()
{
	...
	for (int n = 0; n < SnakeLength; n++)
	{
		...
		if (n > 0)
		{
			App->physics->AddConstraintP2P(*s, **primitives.At(primitives.Count()-2), { 3, 0, 0 }, { -3, 0, 0 });
		}
	...
	App->physics->AddConstraintHinge(**primitives.At(primitives.Count() - 3), **primitives.At(primitives.Count() - 2), { 3, 0, 0 }, { -3, 0, 0 }, { 1, 0, 0 }, { 1, 0, 0 });
